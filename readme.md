...
To learn more about this project you can check out this Wechaty blog post 了解更多可看博客文章: http://wechaty.github.io/2020/06/19/archyshuo-anki-assistant/
...
0. Obtain a [wechaty-puppet-padplus](https://github.com/wechaty/wechaty-puppet-padplus) token or use the web protocol if that works for you. [Learn more about different puppet protocols in WeChaty.](https://github.com/wechaty/wechaty#3-switch-protocolpuppet)
...
- the [WeChaty community](https://wechaty.github.io/) and [everyone involved in making WeChaty such a wonderful tool!](https://github.com/wechaty/wechaty#two_hearts-contributors) And [the Juzi.bot team](https://botorange.com/) for [opening up their padplus protocol ecosystem](https://github.com/juzibot/Welcome/wiki/Support-Developers) for outsiders like me!
...
## Some thoughts about the future 未来打算
  ...
  - Anki is an amazing and very powerful tool but I feel like it is too exam-orientated in the sense that it is best utilised by people (e.g. medical students) with the aim of doing well in an upcoming exam, etc. And from a UI/UX perspective it has a steep learning curve. I'm currently working on a WeChat and TikTok MiniApp inspired by Anki but more laid-back. It is a note-taking tool for people who want to improve Chinese with the intention to read and speak better rather than scoring well in exams. In the premium version it will come with a chatbot assistant like [Archy the Anki bot](https://github.com/archywillhe/archy-the-anki-bot).
...
For anyone who is interested in the development of this project feel free to follow Archy.sh on WeChat and TikTok or [join our mailing list](https://mailing-list.xn--nqr.xn--fiqs8s/) =)
